    ...
    <div className="App">
      ...
      <div className='calculadora-grid'>
        <div className='output'>
          <div className='operando-anterior'> {currentOperation ? number1 + currentOperation : ''} </div>
          <div className='operando-actual'> {result ? result : (!currentOperation ? number1 : number2)} </div>
        </div>
        <button onClick={() => { limpiarTodo() }} className='span-two'>AC</button>
